  ...
  return (
    <div className="report sm:pr-[20px] px-[20px] py-[28px] sm:pl-[40px] sm:py-[52px] ">
      ...
      <div className="btn-group flex sm:justify-start justify-center flex-row gap-[15.3px] sm:gap-[20px] mt-[30px] sm:mt-[40px]">
        <button onClick={handleSend} className="bg-[#38AE00]  shadow-[0px_0px_19.2962px_#38AE00] px-[30px] py-[8px] sm:px-[40px] sm:py-[10px] text-white sm:text-[20px] sm:leading-[30px] text-[15.3px] leading-[23px] font-semibold rounded-[19.3px] sm:rounded-[25.3263px]">
          Send
        </button>

        <button className="bg-[#FF0707] px-[25px] py-[8px] text-[15.3px] leading-[23px] rounded-[24.2px]  shadow-[0px_0px_19.2962px_#FF0707] sm:px-[33px] sm:py-[10px] text-white sm:text-[20px] sm:leading-[30px] font-semibold sm:rounded-[31.6621px]" onClick = {e=> navigate(-1)}>
          Back to Menu
        </button>
      </div>
      <Modal title={"Transaction failed"} setModalShow = {handleModalShow} buttonCaption={"Return to transaction"} show= {modalShow}>
