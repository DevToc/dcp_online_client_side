...
const Movements = () => {
  ...
  return (
    <div className="movements sm:px-[60px] sm:py-[54px] px-[20px] py-[36px]">
      <div className="flex items-start justify-between sm:justify-start flex-wrap xl:items-center flex-row sm:gap-4 max-w-[1075px] ">
        <div className="title sm:min-w-[350px] text-left text-[23px] leading-[34px] sm:text-[37px] sm:leading-[56px]  font-bold text-white">
          Your Movements
        </div>
        <div className="category">
          {screenSize.dynamicWidth >= 640 ? (
            ...
            <select
              name=""
              id=""
              className="py-[6px] px-[22px] bg-[#242424] text-white border-[2.4px] border-[#FF6107] rounded-[21px]  drop-shadow-[0px_0px_12.3px_#FF6107] outline-none"
            >
