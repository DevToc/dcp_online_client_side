  ...
  return (
    <div className="create min-h-screen bg-back px-1 sm:px-5 py-16 flex flex-col relative justify-center items-center">
     <div className="content w-11/12 2xl:w-2/3">
      ...
      <div className="wallet-content bg-[#474747] mt-[46px] px-2 sm:px-[70px] py-[23px] rounded-3xl w-100">
        <div className="title text-center sm:text-left text-[37px] leading-[56px] font-bold text-white">
          New Wallet Opening:
        </div>
        <div>
      ...
      <div
        ...
        className={
          !modalShow
            ? "hidden fixed justify-center flex flex-col items-center z-50 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-auto bg-white rounded-[34px] px-[65px] py-[59px] space-y-5 drop-shadow-lg max-w-[724px] "
            : " fixed justify-center flex flex-col items-center z-50 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-auto bg-white rounded-[34px] px-[65px] py-[59px] space-y-5 drop-shadow-lg max-w-[724px]"
        }
      >
