          ...
          <div className="flex-1 py-[52px] pl-[52px]">
            <ul className="pt-13 pb-4 space-y-[72px] text-[17.7px] leading-[27px] text-[#6c6c6c] font-medium">
              <li className="rounded-sm">
                <HomeMenu isActive={true}></HomeMenu>
              </li>
              <li className="rounded-sm">
                <Movements></Movements>
              </li>
